...
sitjoint=[0,1,2,3,4]
sitedge=[[3, 1],[1, 4],[0, 1], [1, 2]]
def show3D(ax, points, c = (255, 0, 0)):
  points = points.reshape(5, 3)
  ...
  for j in sitjoint:
    ...
    y[j] = - points[j, 1] 
    z[j] = - points[j, 2]
  #xt=[x[12],x[8],x[13],x[6],x[9]]
  #yt=[y[12],y[8],y[13],y[6],y[9]]
  #zt=[z[12],z[8],z[13],z[6],z[9]]
...
def show2D(img, points, c):
  points = ((points.reshape(5, -1))).astype(np.int32)
  for j in sitjoint:
